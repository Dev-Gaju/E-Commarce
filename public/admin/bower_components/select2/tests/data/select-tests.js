...
test('current gets default for details', function (assert) {
  var $select = $('#qunit-fixture .details');
...
test('select works for details', function (assert) {
  var $select = $('#qunit-fixture .details-with-placeholder');
...
test('duplicates - details - same id on select triggers change',
  function (assert) {
...
test('duplicates - details - different id on select triggers change',
  function (assert) {
  var $select = $('#qunit-fixture .duplicates');
